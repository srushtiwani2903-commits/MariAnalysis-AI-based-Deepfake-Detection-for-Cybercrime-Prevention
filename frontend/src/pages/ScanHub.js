            ...
            <form onSubmit={analyzeUrl} className="mt-6 flex flex-col sm:flex-row gap-3 items-end">
              <div className="flex-1 w-full">
                ...
                <input
                  ...
                  className="w-full bg-white/70 dark:bg-white/5 border-2 border-dashed border-slate-300 dark:border-white/15 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-neon-blue/50"
                />
              </div>
